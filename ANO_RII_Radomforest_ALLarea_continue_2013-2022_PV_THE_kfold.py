...
def main():
    ...
    model_path = os.path.join(output_dir, f"PVTHE_random_forest_model_kfold_{region}_{year_range}.pkl")
    scaler_path = os.path.join(output_dir, f"PVTHE_feature_scaler_kfold_{region}_{year_range}.pkl")
    scaler_y_path = os.path.join(output_dir, f"PVTHE_target_scaler_kfold_{region}_{year_range}.pkl")
