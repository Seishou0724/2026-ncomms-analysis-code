...
def main():
    ...
    ann_final = MLPRegressor(**best_params_dict, max_iter=400, early_stopping=True, validation_fraction=0.1, random_state=42)
    ...
    plt.title(f"Assessed RI Index by ANN (MSE) - {region} ({year_range})")
